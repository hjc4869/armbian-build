...
if test "${console}" = "serial" || test "${console}" = "both"; then setenv consoleargs "${consoleargs} earlycon=uart8250,mmio32,0xff1a0000 console=uart8250,mmio32,0xff1a0000"; fi
